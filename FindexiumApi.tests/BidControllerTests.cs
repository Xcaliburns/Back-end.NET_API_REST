...
namespace FindexiumApi.tests
{
    public class BidControllerTests
    {
        ...
        public async Task GetBid_ById_ReturnsOkResult_WithBidResponse()
        {
            ...
            _mockBidService.Setup(service => service.GetByIdAsync(-1))
                    .ReturnsAsync(bid);
        ...
        public async Task PutBid_ReturnsNoContent_WhenBidIsUpdated()
        {
            ...
            _mockBidService.Setup(service => service.UpdateAsync(Id, It.IsAny<BidList>()))
        ...
        public async Task PutBid_ReturnsInternalServerError()
        {
            ...
            _mockBidService.Setup(service => service.GetByIdAsync(Id))
                .ReturnsAsync(new BidList { BidListId = Id });
            _mockBidService.Setup(service => service.UpdateAsync(Id, It.IsAny<BidList>()))
